...
def main(user_data, bot, update):
    ...
    for line in user_data['first_info']:
        ...
        p = r'.*?(?=چهارشنبه|سه شنبه|پنج شنبه|دوشنبه|يکشنبه|شنبه)'
        p2 = r'(?P<day>چهارشنبه|سه شنبه|دوشنبه|پنج شنبه|يکشنبه|شنبه)\s+(?P<start>\d{2}\:\d{2})\s+\-\s+(?P<end>\d{2}\:\d{2})\s*'
        pb = r'(چهارشنبه|سه شنبه|پنج شنبه|دوشنبه|يکشنبه|شنبه)'
        while len(line) != 0:
            try:
                tozih = []
